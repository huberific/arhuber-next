    ...
    <>
      <div className='flex gap-5 mt-10 lg:mt-20 items-center'>
        <div id='intro-container'>
          <p id='hello-text' className='font-normal text-cyan-950 dark:text-cyan-200'>
            Hi, I&apos;m Aaron.
          </p>
      ...
      <div id='resume-link-container' className='page-text flex font-extralight justify-center p-10 lg:p-20 text-cyan-900 dark:text-cyan-200'>
        <Link href='/resume'>
          <motion.p id='my-experience'
