    ...
    <>
      <div className='flex gap-5 mt-10 lg:mt-20 items-center'>
        <div id='intro-container'>
          ...
          <p className='page-text font-extralight text-cyan-50 mt-2'>
      ...
      <div id='resume-link-container' className='page-text flex font-extralight justify-center p-10 lg:p-20 text-cyan-200'>
        <Link href='/resume'>
          <motion.p
